...
2.  **Action**:
    ...
    -   **Context**:
        - `melodie_spec/SYSTEM_PROMPT.md` (The AI Expert & Template)
        - `README.md` (Your Story)
    -   **Prompt**:
        > "Please help me design a Melodie ABM based on my README story. Use the **Design Template** provided in your System Prompt to create a `DESIGN.md` file."
...
1.  **Action**:
    ...
    > **Prompt**:
    > "Using @melodie_spec/SYSTEM_PROMPT.md as the technical guide, read the approved @DESIGN.md. Generate the full project code (core modules, data files, and main.py) by adapting the templates found in the `@melodie_spec/templates/` directory."
